                ...
                @foreach ($tasks as $task)
                    ...
                    <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                        ...
                        <div class="mt-4 flex items-center justify-between gap-3">
                            <button type="button" disabled class="inline-flex cursor-not-allowed items-center rounded-lg bg-slate-900 px-4 py-2 text-sm font-semibold text-white opacity-60">
                                Trigger
                            </button>
